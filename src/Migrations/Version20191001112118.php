 ...
 */
final class Version20191001112118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_order CHANGE product_id product_id INT DEFAULT NULL, CHANGE panier_id panier_id INT DEFAULT NULL');
