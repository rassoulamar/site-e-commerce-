 ...
 */
final class Version20191010220033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_method_id delivery_method_id INT DEFAULT NULL, CHANGE payment_method_id payment_method_id INT DEFAULT NULL, CHANGE command_stat_id command_stat_id INT DEFAULT NULL');
