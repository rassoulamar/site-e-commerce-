 ...
 */
final class Version20191001112856 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_order CHANGE product_id product_id INT DEFAULT NULL, CHANGE order_id order_id INT DEFAULT NULL');
