 ...
 */
final class Version20190927210016 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adress_billing ADD ville_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE adress_billing ADD CONSTRAINT FK_CEC93174A73F0036 FOREIGN KEY (ville_id) REFERENCES ville (id)');
        $this->addSql('CREATE INDEX IDX_CEC93174A73F0036 ON adress_billing (ville_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adress_billing DROP FOREIGN KEY FK_CEC93174A73F0036');
        $this->addSql('DROP INDEX IDX_CEC93174A73F0036 ON adress_billing');
        $this->addSql('ALTER TABLE adress_billing DROP ville_id');
        $this->addSql('ALTER TABLE adress_delivery CHANGE ville_id ville_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE panier CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE panier_product CHANGE panier_id panier_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE marque_id marque_id INT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL');
