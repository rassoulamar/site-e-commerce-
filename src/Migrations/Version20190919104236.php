 ...
 */
final class Version20190919104236 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_detail (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, color VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, size VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, INDEX IDX_4C7A3E374584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
