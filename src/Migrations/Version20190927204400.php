 ...
 */
final class Version20190927204400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ville CHANGE country_id country_id INT DEFAULT NULL, CHANGE adress_billing_id adress_billing_id INT DEFAULT NULL');
