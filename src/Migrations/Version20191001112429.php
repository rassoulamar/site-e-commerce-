 ...
 */
final class Version20191001112429 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_5475E8C4F77D927C ON product_order');
        $this->addSql('ALTER TABLE product_order ADD order_id INT DEFAULT NULL, DROP panier_id, CHANGE product_id product_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_order ADD panier_id INT DEFAULT NULL, DROP order_id, CHANGE product_id product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product_order ADD CONSTRAINT FK_5475E8C4F77D927C FOREIGN KEY (panier_id) REFERENCES `order` (id)');
        $this->addSql('CREATE INDEX IDX_5475E8C4F77D927C ON product_order (panier_id)');
