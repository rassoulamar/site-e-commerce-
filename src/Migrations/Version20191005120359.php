 ...
 */
final class Version20191005120359 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD payment_method_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_method_id delivery_method_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67D5AA1164F FOREIGN KEY (payment_method_id) REFERENCES payment_method (id)');
        $this->addSql('CREATE INDEX IDX_6EEAA67D5AA1164F ON commande (payment_method_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP FOREIGN KEY FK_6EEAA67D5AA1164F');
        $this->addSql('DROP INDEX IDX_6EEAA67D5AA1164F ON commande');
        $this->addSql('ALTER TABLE commande DROP payment_method_id, CHANGE user_id user_id INT DEFAULT NULL, CHANGE delivery_method_id delivery_method_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ligne_commande CHANGE commande_id commande_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product CHANGE categorie_id categorie_id INT DEFAULT NULL, CHANGE marque_id marque_id INT DEFAULT NULL, CHANGE image_id image_id INT DEFAULT NULL');
